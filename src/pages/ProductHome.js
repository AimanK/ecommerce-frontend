...
function ProductHome() {
  return (
    <div>
                ...
                <div class="position-relative overflow-hidden p-3 p-md-5 m-md-3 text-center bg-light opacity-50">
                ...
                <div class="row">
                    ...
                    <ul class="list-unstyled text-small">
                        <li><a class="link-secondary" href="#">Lighting Fixtures</a></li>
                        <li><a class="link-secondary" href="#">Chairs</a></li>
                        <li><a class="link-secondary" href="#">Tables</a></li>
                        <li><a class="link-secondary" href="#">Beds</a></li>
                        <li><a class="link-secondary" href="#">Area Rugs</a></li>
                        <li><a class="link-secondary" href="#">Decor</a></li>
                    </ul>
                    </div>
                    <div class="col-6 col-md">
                    <h5>About Us</h5>
                    ...
                    <h5>Source Code</h5>
                    <ul class="list-unstyled text-small">
                        <li><a class="link-secondary" href="#">Github Code</a></li>
                    </ul>
                    </div>
                </div>
                </footer>
